    ...
    <div style={{ position: "relative" }}>
      <div style={{
        ...
        {Array.from({ length: 64 }, (_, i) => {
          ...
          const isKnight = r === 5 && c === 5;
          const isTarget = r === 3 && c === 4;
          const isHov = hovered === i;

          let bg = isLight ? P.board1 : P.board2;
          if (isKnight) bg = isLight ? "#b5d87a" : "#8cad50";
    ...
    <section style={{
      ...
      <div style={{ flex: "1 1 400px", maxWidth: 500 }}>
        <Reveal delay={0}>
          ...
          }}>meet your kid's new chess coach →</div>
        </Reveal>
        <Reveal delay={150}>
          <h1 style={{
        ...
        <Reveal delay={600}>
          <div style={{ display: "flex", gap: 32, marginTop: 48 }}>
            {[
              { icon: "🎯", label: "Ages 5–12" },
              { icon: "🧠", label: "AI-powered" },
              { icon: "🛡", label: "Ad-free & safe" },
            ].map((item, i) => (
...
function Testimonials() {
  const quotes = [
    { text: "She went from not knowing how the knight moves to beating her uncle in three weeks. Coach Pawn did what two chess books couldn't.", name: "Sarah M.", role: "Mom of a 7-year-old", emoji: "👩" },
    { text: "The coaching isn't generic. When my son hung his queen, Coach Pawn said exactly why it happened and what to look for next time.", name: "Raj K.", role: "Chess dad, ELO 1400", emoji: "👨" },
    { text: "My son used to cry when he lost. Now he says 'Coach Pawn told me what to try next time!' and immediately starts a new game.", name: "Emily T.", role: "Parent of 3", emoji: "👩" },
  ];
  return (
    <section style={{ padding: "80px 28px", maxWidth: 960, margin: "0 auto", position: "relative", zIndex: 1 }}>
      <Reveal>
        <span style={{ fontFamily: "'Caveat', cursive", fontSize: 19, color: P.gold, display: "block", textAlign: "center", marginBottom: 8 }}>from real families</span>
        <h2 style={{ fontSize: 32, fontWeight: 900, fontFamily: "var(--font-playfair), serif", textAlign: "center", margin: "0 0 44px", color: P.ink }}>
          &quot;My kid asks to play every day&quot;
        </h2>
      </Reveal>
        ...
        {quotes.map((q, i) => (
          <Reveal key={i} delay={i * 120}>
            <div style={{
              ...
              boxShadow: `0 4px 24px ${P.inkGhost}40`,
              transition: "all 0.3s cubic-bezier(0.34,1.56,0.64,1)",
              cursor: "default", height: "100%",
            }}
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(-6px)"; (e.currentTarget as HTMLElement).style.boxShadow = `0 12px 40px ${P.inkGhost}60`; }}
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLElement).style.boxShadow = `0 4px 24px ${P.inkGhost}40`; }}
            >
              <div style={{ display: "flex", gap: 3, marginBottom: 16 }}>
                {[1,2,3,4,5].map(s => <span key={s} style={{ color: P.goldLight, fontSize: 15 }}>★</span>)}
              </div>
              <p style={{ fontSize: 15, lineHeight: 1.8, color: P.inkSoft, margin: "0 0 24px", fontFamily: "var(--font-nunito), sans-serif" }}>&quot;{q.text}&quot;</p>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{
                  width: 38, height: 38, borderRadius: "50%",
                  background: P.parchment, display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 18, border: `2px solid ${P.inkGhost}`,
                }}>{q.emoji}</div>
                <div>
                  <div style={{ fontSize: 14, fontWeight: 700, color: P.ink, fontFamily: "var(--font-nunito), sans-serif" }}>{q.name}</div>
                  <div style={{ fontSize: 11, color: P.inkFaint }}>{q.role}</div>
                </div>
              </div>
            </div>
          </Reveal>
          ...
          <div style={{ padding: "28px 32px", borderBottom: `1px solid ${P.parchment}` }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
                ...
                <p style={{ margin: 0, fontSize: 14, color: P.inkLight, fontFamily: "var(--font-nunito), sans-serif" }}>3 games/day · text coaching · 2 difficulty levels</p>
              </div>
          ...
          <div style={{ padding: "32px", background: `linear-gradient(135deg, ${P.emeraldPale} 0%, ${P.goldPale} 100%)` }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <div style={{ flex: 1 }}>
                ...
                <p style={{ margin: 0, fontSize: 14, color: P.inkLight, fontFamily: "var(--font-nunito), sans-serif" }}>
                  Unlimited games · all levels · detailed coaching · game review · priority AI
                </p>
              </div>
            ...
            <Link href="/onboard" style={{
              display: "block", width: "100%", marginTop: 24, padding: "16px 0", borderRadius: 14,
              background: P.ink, color: P.cream, border: "none",
      ...
      <footer style={{
        ...
        <div style={{ display: "flex", gap: 20 }}>
          {["Privacy", "Terms", "Contact"].map(l => (
            <a key={l} href="#" style={{ color: P.inkFaint, fontSize: 13, textDecoration: "none", fontFamily: "var(--font-nunito), sans-serif" }}>{l}</a>
          ))}
        </div>
