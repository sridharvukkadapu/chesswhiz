    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ fontSize: 16, fontWeight: 900, fontFamily: "var(--font-dm-serif), serif", color: P.ink }}>
            ChessWhiz
          </span>
        </div>
        <div style={{ width: 90 }} />
      ...
      <section style={{ maxWidth: 720, margin: "0 auto", padding: "36px 20px 20px", position: "relative", zIndex: 1, textAlign: "center" }}>
        ...
        <h1 style={{
          ...
          fontFamily: "var(--font-dm-serif), serif", color: P.ink, letterSpacing: -1,
        }}>{kingdom.name}</h1>
          ...
          {kingdom.strategies.map((s) => {
            ...
            return (
              <div key={s.id} style={{
                ...
                background: mastered ? P.emeraldPale : P.creamDeep,
      ...
      <section style={{ maxWidth: 720, margin: "0 auto", padding: "36px 20px 80px", position: "relative", zIndex: 1, textAlign: "center" }}>
        <button type="button"
          ...
          style={{
            ...
            boxShadow: "0 8px 32px rgba(124,182,158,0.30), 0 2px 8px rgba(124,182,158,0.20)",
